...
const Third = () => {
  return (
    <div className="mt-[3rem] mb-[4rem] grid grid-cols-3 gap-[4rem] md:grid-cols-2 md:gap-[2rem] sm:grid-cols-1 sm:gap-[3rem]">
      <div className="flex gap-5">
        <div>
          <img src={RetroPc} alt="pc" className="h-[8rem] w-[10rem] md:h-[11rem]" />
        </div>
        <div className="">
      ...
      <div className="flex gap-5">
        <div>
          <img src={Laptop} alt="pc" className="h-[8rem] w-[10rem] md:h-[11rem]" />
        </div>
      ...
      <div className="flex gap-5">
        <div>
          <img src={Gaming} alt="pc" className="h-[8rem] w-[10rem] md:h-[11rem]" />
        </div>
        <div className="gap-y-5">
